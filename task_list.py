...
def add_to_list(t, s=False):
    ...
    if t == "" or t is None:
        return
    cb = ctk.CTkCheckBox(scrollable_frame1, text=t , text_color="White" , bg_color="#303633")
...
def make_btns():
    ...
    for i in files:
        ...
        btns.append(bt)
    for i in btns:
        i.pack(anchor="w", pady=3, padx=10)
...
def main_task():
    ...
    middle_frame = ctk.CTkFrame(win, width=247, height=500, fg_color="#303633",bg_color="#303633" )
    right_frame = ctk.CTkFrame(win, width=197, height=500, bg_color="#303633")

    separator_left_middle = ctk.CTkCanvas(win, width=3, height=500, bg="#303633")
    separator_middle_right = ctk.CTkCanvas(win, width=3, height=500, bg="#303633")
    ...
    canvas1 = ctk.CTkCanvas(left_frame, width=297, height=510, bg="#303633")
    canvas3 = ctk.CTkCanvas(right_frame, width=200, height=510, bg="#303633")

    scrollbar1 = ctk.CTkScrollbar(left_frame,fg_color="#303633",bg_color="#303633", orientation="vertical", command=canvas1.yview, height=500)
    scrollable_frame1 = ctk.CTkFrame(canvas1, fg_color="#303633",width=297, bg_color="#303633", height=505)

    scrollbar3 = ctk.CTkScrollbar(right_frame,fg_color="#303633", bg_color="#303633", orientation="vertical", command=canvas3.yview, height=505)
    scrollable_frame3 = ctk.CTkFrame(canvas3,fg_color="#303633", bg_color="#303633", height=505)
    ...
    scrollbar1.place(x=277, y=0)
    canvas3.place(x=0, y=-5)
    scrollbar3.place(x=190, y=0)

    task_entry.place(x=25, y=10)
    add_bt.place(x=25, y=45)
    save_bt.place(x=25, y=80)
    del_entry.place(x=25, y=150)
    del_bt.place(x=25, y=180)
    del_file_bt.place(x=25, y=220)
    new_file_entry.place(x=25, y=410)
    new_file_bt.place(x=25, y=450)
