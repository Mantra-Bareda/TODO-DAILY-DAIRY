...
def main_task():
    ...
    task_entry.place(x=0 + pos_x_2, y=10 + pos_y_2)
    del_entry.place(x=0 + pos_x_2, y=150 + pos_y_2)
    add_bt.place(x=0 + pos_x_2, y=45 + pos_y_2)
    del_bt.place(x=0 + pos_x_2, y=180 + pos_y_2)
    del_file_bt.place(x=0 + pos_x_2, y=220 + pos_y_2)
    save_bt.place(x=0 + pos_x_2, y=80 + pos_y_2)

    new_file_entry.place(x=0 + pos_x_2, y=410 + pos_y_2)
    new_file_bt.place(x=0 + pos_x_2, y=450 + pos_y_2)
